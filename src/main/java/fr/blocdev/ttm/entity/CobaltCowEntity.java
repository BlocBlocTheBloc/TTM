...
import fr.blocdev.ttm.procedures.CobaltCowProProcedure;
import fr.blocdev.ttm.entity.renderer.CobaltCowRenderer;
...
public class CobaltCowEntity extends TtmModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Cobalt Cow"));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				CobaltCowProProcedure.executeProcedure($_dependencies);
			}
		}
