...
import fr.blocdev.ttm.entity.renderer.AncientSlimeRenderer;
import fr.blocdev.ttm.TtmModElements;

@TtmModElements.ModElement.Tag
public class AncientSlimeEntity extends TtmModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777114, -16750849, new Item.Properties().group(TTMItemGroup.tab))
				.setRegistryName("ancient_slime_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 5, 1, 6));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(AncientDustItem.block));
		}
