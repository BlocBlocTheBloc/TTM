...
public class SteelTankBlock extends TtmModElements.ModElement {
	@ObjectHolder("ttm:steel_tank")
	public static final Block block = null;
	@ObjectHolder("ttm:steel_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SteelTankBlock(TtmModElements instance) {
		super(instance, 54);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("steel_tank"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("steel_tank");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Steel Tank");
		}
